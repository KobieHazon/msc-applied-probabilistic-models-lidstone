...
class OutputFileWriter:
    ...
    def __init__(self, output_file_name: str):
        self._output_file = open(output_file_name, "w")  # open the output file
    ...
    def write(self, to_write: Any):
        ...
        self._output_file.write(f"#Output{self._output_counter}\t{to_write}\n")  # format asked for by the exercise
    ...
    def file_name(self) -> str:
        return os.path.basename(self._output_file.name)  # instructed to only write the base name of the file
