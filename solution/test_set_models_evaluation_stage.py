...
def test_set_models_evaluation(output_writer: OutputFileWriter,
    ...
    articles_words_count = test_processed_documents.count_article_words()  # number of words in the test dataset
    ...
    test_set = tuple(test_processed_documents.iter_article_words())  # all the words in the test dataset
